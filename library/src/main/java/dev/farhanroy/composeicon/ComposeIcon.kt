...
private fun getFontFamily(composeIconType: ComposeIconType): FontFamily {
    return when (composeIconType) {
        is ComposeIconType.BrandIcon -> FontFamily(
            Font(R.font.fa_brands_400)
        )
        is ComposeIconType.SolidIcon -> FontFamily(
            Font(R.font.fa_solid_900)
        )
        is ComposeIconType.RegularIcon -> FontFamily(
